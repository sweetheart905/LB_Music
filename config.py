...
OWNER_ID = int(getenv("OWNER_ID", "8174552286"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/DPZ_WORLD_STORY")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/rudra_ki_duniya_89")
